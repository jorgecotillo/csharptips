using EF_CodeFirst_Data.Interfaces;
...
namespace EF_CodeFirst_Data
{
    ...
    /// Object context
    /// </summary>
    public class EFCustomContext : DbContext, IDbContext, IODSDbContext
    {
        public EFCustomContext(string nameOrConnectionString)
        ...
        public object[] ExecuteStoredProcedureMultipleResult(string commandText, params object[] parameters)
        {
            //HACK: Entity Framework Code First doesn't support doesn't support output parameters
            //That's why we have to manually create command and execute it.
            //just wait until EF Code First starts support them
